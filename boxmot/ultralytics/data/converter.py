...
from boxmot.ultralytics.utils import LOGGER, TQDM
...
def convert_coco(labels_dir='../coco/annotations/',
    ...
    Example:
        ```python
        from boxmot.ultralytics.data.converter import convert_coco
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from boxmot.ultralytics.data.converter import convert_dota_to_yolo_obb
