...
from boxmot.ultralytics.nn.autobackend import check_class_names
from boxmot.ultralytics.utils import (DATASETS_DIR, LOGGER, NUM_THREADS, ROOT, SETTINGS_YAML, TQDM, clean_url, colorstr,
                               emojis, yaml_load)
from boxmot.ultralytics.utils.checks import check_file, check_font, is_ascii
from boxmot.ultralytics.utils.downloads import download, safe_download, unzip_file
from boxmot.ultralytics.utils.ops import segments2boxes
...
class HUBDatasetStats:
    ...
    def process_images(self):
        ...
        from boxmot.ultralytics.data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Example:
        ```python
        from pathlib import Path
        from boxmot.ultralytics.data.utils import compress_one_image
...
def autosplit(path=DATASETS_DIR / 'coco8/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Example:
        ```python
        from boxmot.ultralytics.data.utils import autosplit
