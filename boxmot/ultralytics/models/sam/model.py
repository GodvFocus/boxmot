...
This module provides an interface to the Segment Anything Model (SAM) from boxmot.ultralytics, designed for real-time image
...
from boxmot.ultralytics.utils.torch_utils import model_info
