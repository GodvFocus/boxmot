...
from boxmot.ultralytics.hub.utils import HUB_API_ROOT, HUB_WEB_ROOT, PREFIX, smart_request
from boxmot.ultralytics.utils import LOGGER, __version__, checks, emojis, is_colab, threaded
from boxmot.ultralytics.utils.errors import HUBModelError
...
class HUBTrainingSession:
    ...
    Attributes:
        ...
        model (dict): Model data fetched from boxmot.ultralytics HUB.
    ...
    def _get_model(self):
        """Fetch and return model data from boxmot.ultralytics HUB."""
