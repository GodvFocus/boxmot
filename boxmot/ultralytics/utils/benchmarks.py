...
Usage:
    from boxmot.ultralytics.utils.benchmarks import ProfileModels, benchmark
...
from boxmot.ultralytics.cfg import TASK2DATA, TASK2METRIC
from boxmot.ultralytics.engine.exporter import export_formats
from boxmot.ultralytics.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from boxmot.ultralytics.utils.checks import check_requirements, check_yolo
from boxmot.ultralytics.utils.files import file_size
...
class ProfileModels:
    ...
    Example:
        ```python
        from boxmot.ultralytics.utils.benchmarks import ProfileModels
