...
from boxmot.ultralytics.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, __version__
...
def strip_optimizer(f: Union[str, Path] = 'best.pt', s: str = '') -> None:
    ...
    Example:
        ```python
        from pathlib import Path
        from boxmot.ultralytics.utils.torch_utils import strip_optimizer
...
def profile(input, ops, n=10, device=None):
    ...
    Example:
        ```python
        from boxmot.ultralytics.utils.torch_utils import profile
